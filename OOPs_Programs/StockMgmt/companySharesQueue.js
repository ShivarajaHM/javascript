...
class companySharesQueue {
  constructor() {
    this.queue = new accessDs.QueueLinked();
    try {
      /**
       * Pass the path of json file and read it and enqueue the objects using add method of queue
       */
      var data = JSON.parse(
        file.readFileSync("/home/admin1/Documents/javascript/OOPs_Programs/JSON_files/queue.json")
      );
  ...
  writeList() {
     ...
     */
    file.writeFileSync(
      "/home/admin1/Documents/javascript/OOPs_Programs/JSON_files/queue.json",
