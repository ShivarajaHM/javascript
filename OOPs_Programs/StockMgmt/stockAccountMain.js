 ...
 * @since           : 16/02/2019
 * **************************************************************************************/
var D=require('../StockMgmt/stockAccount')
...
function main() {
    try {
        ...
        */
        var customeData = file.readFileSync('/home/admin1/Documents/javascript/OOPs_Programs/JSON_files/customer.json', "utf8");
        var companyData = file.readFileSync('/home/admin1/Documents/javascript/OOPs_Programs/JSON_files/company.json', "utf8");
        /**
        * Parse the json files to objects
        */
        var customerDataJson = JSON.parse(customeData);
