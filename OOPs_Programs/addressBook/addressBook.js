        ...
        try {
            ...
            while (!nameValidation.test(name)) {
                if (nameValidation.test(name))
                    break;
                var name = readline.question("Please enter your valid first name : ");
            }
            ...
            while (!nameValidation.test(lastName)) {
                if (nameValidation.test(lastName))
                    break;
                var lastName = readline.question("Please enter your valid last name : ");
            }
            ...
            */
            file.writeFile("/home/admin1/Documents/javascript/OOPs_Programs/JSON_files/adressBook.json",
                JSON.stringify(this.addressBookData), "utf-8",
                function (err) {
                    if (err) throw err;
    ...
    openProfile() {
        try {
            ...
            if (this.addressBookData.Person.length > 0) {
                 ...
                 */
                for (var index = 0;index < this.addressBookData.Person.length;index++) {
                    console.log(this.addressBookData.Person[index]);
                }
                console.log("\nWelcome!!\n");
                var update = readline.question("Please enter the name of the profile to perform operations: ");
                    ...
                    if (update == this.addressBookData.Person[key].Name) {
                        ...
                        switch (parseInt(choice2)) {
                            ...
                            case 2:
                                 ...
                                 */
                                for (let key = 0;key < this.addressBookData.Person.length;key++) {
