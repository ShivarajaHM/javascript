    ...
    clinicManagement(clinicJsonObject) {
        try {
            ...
            if (choice == 1) {
                 ...
                 */
                file.writeFileSync("/home/admin1/Documents/javascript/OOPs_Programs/JSON_files/clinicMgmt.json",
                    JSON.stringify(clinicJsonObject));
                console.log("Your appointment is confirmed on " + day + "/" + month + "/" + year);
